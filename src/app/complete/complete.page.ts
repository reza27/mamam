  ...
  template: `
    ...
    <ion-content [fullscreen]="true" class="ion-padding">
      <app-mm-card title="Assessment Complete!">
        <p class="m-b-2">
          Congratulations on completing the Mama Money Frontend Technical
          Assessment!
        </p>
        <p class="m-b-2">
          We value your feedback and would appreciate your thoughts on the
          assessment experience.
        </p>
        <p>
          <i
            ><strong>Note:</strong> Providing feedback is optional but greatly
            appreciated</i
          >
        </p>
      </app-mm-card>
